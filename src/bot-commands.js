    ...
    switch (interaction.commandName) {
      ...
      case "meow":
        ...
        if (random === 1) {
          ...
          interaction.reply(
            "the ting go uwaaaa! >///< nya nya nya nya nya! :3"
          );
        } else if (random === 3) {
      ...
      case "build":
        ...
        if (characterId === 0) {
          embed
            .setTitle("Dr. Ratio")
            .setDescription("Best build(s) for Dr. Ratio. (Taken from Prydwen)")
            .setURL("https://www.prydwen.gg/star-rail/characters/dr-ratio")
            .addFields(
              {
                name: "Top Relic Sets",
                value:
